...
export function QRFormsTab() {
  ...
  const ambulances: AmbulanceQR[] = [
    { id: "A-01", patente: "XXYZ-12", qrStatus: "activo", formLink: "https://forms.app/ambulancia/A-01", lastScan: "Hace 2 horas" },
    { id: "A-02", patente: "ABCD-34", qrStatus: "activo", formLink: "https://forms.app/ambulancia/A-02", lastScan: "Hace 5 minutos" },
    { id: "A-03", patente: "EFGH-56", qrStatus: "activo", formLink: "https://forms.app/ambulancia/A-03", lastScan: "Hace 1 día" },
    { id: "A-04", patente: "IJKL-78", qrStatus: "activo", formLink: "https://forms.app/ambulancia/A-04", lastScan: "Hace 3 horas" },
    { id: "A-05", patente: "MNOP-90", qrStatus: "pendiente", formLink: "https://forms.app/ambulancia/A-05", lastScan: "Nunca" },
    { id: "A-06", patente: "QRST-11", qrStatus: "inactivo", formLink: "https://forms.app/ambulancia/A-06", lastScan: "Hace 15 días" },
    { id: "A-07", patente: "UVWX-22", qrStatus: "activo", formLink: "https://forms.app/ambulancia/A-07", lastScan: "Hace 1 hora" },
    { id: "A-08", patente: "YZAB-33", qrStatus: "activo", formLink: "https://forms.app/ambulancia/A-08", lastScan: "Hace 30 minutos" },
    { id: "A-09", patente: "CDEF-44", qrStatus: "activo", formLink: "https://forms.app/ambulancia/A-09", lastScan: "Hace 4 horas" },
    { id: "A-10", patente: "GHIJ-55", qrStatus: "activo", formLink: "https://forms.app/ambulancia/A-10", lastScan: "Hace 2 días" },
    { id: "A-11", patente: "KLMN-66", qrStatus: "activo", formLink: "https://forms.app/ambulancia/A-11", lastScan: "Hace 6 horas" },
